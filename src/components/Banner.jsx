  ...
  return (
    <div className="banner px-12 lg:px-64 relative flex justify-between">
      <div className="banner-deescription p-3">
        ...
        <p className="font-semibold text-lg text-red-600 my-4">
          Get Started Today!
        </p>
        <div className="btn-container flex flex-col">
          ...
          >
            <Button size={"medium"}>Create your own pizza</Button>
          </Link>
          <a
            href="#pizza-carousle"
            className="text-lg text-yellow-400 hover:text-yellow-500 font-bold text-decoration-line px-3 mt-4"
          >
            See Menu
          </a>
        </div>
